...
(0, _react2.storiesOf)('Bar Chart', module)
  .add('Small', function() {
    return _react.default.createElement(
      _.Chart,
      {
  ...
  .add('Tooltip', function() {
    return _react.default.createElement(
      ...
      _react.default.createElement(_.YAxis, null),
      _react.default.createElement(_.XAxis, {
        dataKey: 'date',
        tickFormatter: _formatters.default.date()
      }),
...
(0, _react2.storiesOf)('Line Chart', module)
  .add('Small', function() {
    return _react.default.createElement(
      _.Chart,
      {
...
(0, _react2.storiesOf)('Tooltip', module)
  .add(
    'TooltipBody',
    function() {
      return _react.default.createElement(
...
(0, _react2.storiesOf)('Report Card Summary', module)
...
(0, _react2.storiesOf)('Report Card', module)
  .add('w/Chart,Title', function() {
    return _react.default.createElement(
      _.ReportCard,
      null,
...
(0, _react2.storiesOf)('formatters', module)
  .add('date', function() {
    return _react.default.createElement(
      'div',
      null,
      _react.default.createElement(
        ...
        _formatters.default.date('hour')('2018-01-15T23:43:32')
      ),
      ...
      _react.default.createElement(
        ...
        "formatters.date('day')",
        _react.default.createElement('div', null, '->'),
        _formatters.default.date('day')('2018-01-15T23:43:32')
      ),
      _react.default.createElement('br', null),
      _react.default.createElement(
        'div',
        ...
        _react.default.createElement('div', null, '->'),
        _formatters.default.date('week')('2018-01-15T23:43:32')
      ),
      _react.default.createElement('br', null),
      _react.default.createElement(
        'div',
        ...
        _react.default.createElement('div', null, '->'),
        _formatters.default.date('month')('2018-01-15T23:43:32')
      ),
      _react.default.createElement('br', null),
      _react.default.createElement(
        'div',
        ...
        _react.default.createElement('div', null, '->'),
        _formatters.default.date('year')('2018-01-15T23:43:32')
      )
    );
  })
  .add('capitalize', function() {
    return _react.default.createElement(
      ...
      _react.default.createElement('div', null, '->'),
      _formatters.default.capitalize('podium')
    );
  })
  .add('abbreviateNumber', function() {
    return _react.default.createElement(
      ...
      _react.default.createElement('div', null, '->'),
      _formatters.default.abbreviateNumber(100000000)
    );
  })
  .add('humanizeDuration', function() {
    return _react.default.createElement(
      ...
      _react.default.createElement('div', null, '->'),
      _formatters.default.humanizeDuration(86400)
    );
  })
  .add('commatize', function() {
    return _react.default.createElement(
      ...
      _react.default.createElement('div', null, '->'),
      _formatters.default.commatize(1000000000)
    );
  });
