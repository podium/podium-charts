...
function (_React$Component) {
  ...
  function Chart() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(Chart)).call.apply(_getPrototypeOf2, [this].concat(args))), _this.renderChildren = function (mapping) {
    ...
    }, _this.renderXAxis = function (_ref) {
    ...
    }, _this.renderYAxis = function (props) {
    ...
    }, _this.renderLine = function (_ref3) {
    ...
    }, _this.renderSummaryLine = function (_ref4) {
      ...
      return _react.default.createElement(_recharts.Line, _extends({
        ...
        dot: function dot(data) {
          if (data.index === _this.props.data.length - 1) {
